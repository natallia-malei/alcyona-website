  ...
  return (
    <section className="py-16 px-6 md:px-12 bg-[--color-bg-elevated]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <a
          href={band.telegramChannel}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-[#229ED9] hover:bg-[#1a82b3] text-white px-8 py-3 uppercase tracking-widest text-sm font-semibold transition-colors"
        >
